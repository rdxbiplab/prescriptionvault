...
if(isset($_POST["send"])){
	...
	$mail->IsSMTP(); 
	$mail->Host = google.com; //Hostname of the mail server
	$mail->Port = SMTP_PORT; //Port of the SMTP like to be 25, 80, 465 or 587
	$mail->SMTPAuth = true; //Whether to use SMTP authentication
	$mail->Username = nxgbiplab; //Username for SMTP authentication any valid email created in your domain
	$mail->Password = nxgbpee; //Password for SMTP authentication
	$mail->AddReplyTo("nxgbiplab@gnail.com.com", "Reply name"); //reply-to address
	$mail->SetFrom("nxgbiplab@gnail.com", "bpee SMTP Mailer"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Your SMTP Mail"; //Subject od your mail
	$mail->AddAddress($email, "Biplab"); //To address who will receive this email
